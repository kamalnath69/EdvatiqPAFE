...
export default function Pricing() {
  ...
  return (
    <div className="public-page-shell pricing-shell">
      ...
      <section className="public-page-section pricing-section">
      ...
      <section className="public-page-section pricing-section pricing-assurance-grid">
